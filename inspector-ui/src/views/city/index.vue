<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="1=省份, 2=城市" prop="level">
        <el-input
          v-model="queryParams.level"
          placeholder="请输入1=省份, 2=城市"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
    ...
    <el-table v-loading="loading" :data="cityList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="1=省份, 2=城市" align="center" prop="level" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        <el-row>
          ...
          <el-col :span="24">
            <el-form-item label="1=省份, 2=城市" prop="level">
              <el-input v-model="form.level" placeholder="请输入1=省份, 2=城市" />
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
